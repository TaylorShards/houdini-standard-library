...
*   **Typed:** Everything uses `@property` with strict CSS Values API syntax.
...
Paste the following block into your global `app.css` or `reset.css`. This is your engine.
...
/* 3. TRANSFORM / MOTION ("Physics Layer") - Non-Inheriting */
